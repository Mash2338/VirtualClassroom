...
void interactWithTeacher() {
	...
	char str1[] = "Why did you not go home yet? Is there something wrong?";
	...
	for (int i = 0; i < l1; i++) // loop until i is lesser then l1
	{
...
void renderScene(void) {
	...
	//wall
	glColor3f(0.9294f, 0.9216f, 0.9216f);
	glBegin(GL_QUADS);
	glVertex3f(-10.0f, 0.0f, -10.0f);
